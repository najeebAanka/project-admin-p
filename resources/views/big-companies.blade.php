...
<body class="fixed-navbar">
 ...
 @include('shared.side-nav')       
     ...
     <div class="page-heading">
        <h1 class="page-title">Former Companies Management</h1>
        {{-- <ol class="breadcrumb">
    ...
    <div class="page-content fade-in-up">
        ...
        <div class="ibox">
            <div class="ibox-head">
                ...
                <div class="ibox-title">Former Companies Management</div>
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <?php
                                $data = \App\Models\BigCompany::orderBy('id' ,'desc')->paginate(10);
                                foreach ($data as $d) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        style="margin-bottom: 3px">
                                         ...
                                         <form method="post" action="{{url('admin/backend/big-companies/delete')}}">
                                            {{csrf_field()}}
                                        ...
                                        <div class="modal fade" id="exampleModal<?php echo $d->id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                              <div class="modal-content">
                                                  ...
                                                  <form method="post" action="{{url('admin/backend/big-companies/edit')}}" enctype="multipart/form-data"> 
                                                    {{csrf_field()}}
                                                <input type="hidden" name="id" value="<?php echo $d->id; ?>" />
    ...
    <div class="modal fade" id="exampleModalAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
              ...
              <form method="post" action="{{url('admin/backend/big-companies/add')}}"  enctype="multipart/form-data">
                {{csrf_field()}}
