                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <?php
                                $data = \App\Models\Job::orderBy('id' ,'desc')->paginate(10);
                                foreach ($data as $d) { ?>
                                <tr>
                              
                                    <td><?php echo $d->id; ?></td>
                                    <td><?php echo $d->title_en; ?></td>
                                    <td style="text-align: center; direction: rtl;"><?php echo $d->title_ar; ?></td>
                                    <td><?php echo $d->domain_en; ?></td>
                                    <td style="text-align: right; direction: rtl;"><?php echo $d->domain_ar; ?></td>
                                    <td><?php echo substr($d->date,0, 10) ; ?></td>
                                    ...
                                    <td>
                                        ...
                                        style="margin-bottom: 3px">
                                         ...
                                         <form method="post" action="{{url('admin/backend/jobs/delete')}}">
                                            {{csrf_field()}}
                                        ...
                                        <div class="modal fade" id="exampleModal<?php echo $d->id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                              <div class="modal-content">
                                                  ...
                                                  <form method="post" action="{{url('admin/backend/jobs/edit')}}">
                                                    {{csrf_field()}}
                                                <input type="hidden" name="id" value="<?php echo $d->id; ?>" />
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                      ...
                                                      <div class="form-group">
                                                        <label for="exampleInputEmail1">Domain (En)</label>
                                                        <input type="text" class="form-control" name="domain_en" required
                                                        value="<?php echo $d->domain_en; ?>"
                                                         aria-describedby="emailHelp" placeholder="English">
                                                        <small id="emailHelp" class="form-text text-muted"></small>
                                                      </div>
                                                      <div class="form-group">
                                                        <label for="exampleInputPassword1">Domain (Ar)</label>
                                                        <input type="text" name="domain_ar" class="form-control" required
                                                        value="<?php echo $d->domain_ar; ?>"
                                                        placeholder="Arabic">
                                                      </div>
                                                      <div class="form-group">
                                                        <label for="exampleInputPassword1">Date</label>
                                                        <input type="date" name="date" class="form-control" required
                                                        value="<?php echo $d->date; ?>"
                                                        placeholder="Date">
                                                      </div>
                                                </div>
    ...
    <div class="modal fade" id="exampleModalAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
              ...
              <form method="post" action="{{url('admin/backend/jobs/add')}}">
                {{csrf_field()}}
            ...
            <div class="modal-body">
                  ...
                  <div class="form-group">
                    <label for="exampleInputPassword1">Doamin (Ar)</label>
                    <input type="text" name="domain_ar" class="form-control" required
      ...
      <p style="margin-top: 15px; float:right;" <?php if($data->lastPage() == 1){echo "hidden";} ?>>
                ...
                <span> << </span>
                <a href="{{url("admin/jobs")}}<?php echo "?page=1"; ?>">First Page</a>
                <span <?php if($data->lastPage() == 2){echo "hidden";} ?>> | </span>
                <a href="{{url("admin/jobs")}}<?php echo "?page=".round($data->lastPage()/2); ?>" <?php if($data->lastPage() == 2){echo "hidden";} ?>>Middle Page</a>
                <span> | </span>
                <a href="{{url("admin/jobs")}}<?php echo "?page=".$data->lastPage(); ?>">Last Page</a>
                <span> >> </span>
