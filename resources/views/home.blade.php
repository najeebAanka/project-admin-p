        ...
        <div class="content-wrapper" style="margin-top: 15px">
            ...
            <!-- START PAGE CONTENT-->
             <div class="page-content fade-in-up">
                <div class="row">
                    <div class="col-md-6">
                        <div class="ibox widget-stat color-white" style="background-color: #4b647c">
                           <a href="{{url('admin/projects')}}" class="color-white"> <div class="ibox-body">
                                <h2 class="m-b-5 font-strong">
                                    <?php
                                        $d = \App\Models\Project::get();
                                        echo $d->count();
                                    ?>
                                </h2>
                                <div class="m-b-5">PROJECTS</div><i class="fa fa-map widget-stat-icon"></i>
                    ...
                    <div class=" col-md-6">
                        <div class="ibox  widget-stat color-white" style="background-color: #4b647c">
                            <a href="{{url('admin/services')}}" class="color-white"><div class="ibox-body">
                                <h2 class="m-b-5 font-strong">
                                    <?php
                                        $d = \App\Models\Service::get();
                                        echo $d->count();
                                    ?>
                                </h2>
                                <div class="m-b-5">SERVICES</div><i class="fa fa-edit widget-stat-icon"></i>
                    ...
                    <div class=" col-md-6">
                        <div class="ibox widget-stat color-white" style="background-color: #4b647c">
                            <a href="{{url('admin/contact')}}" class="color-white"><div class="ibox-body">
                                <h2 class="m-b-5 font-strong">
                                    <?php
                                        $d = \App\Models\Contact::get();
                                        echo $d->count();
                                    ?>
                                </h2>
                                <div class="m-b-5">MESSAGES</div><i class="fa fa-smile-o widget-stat-icon"></i>
                    ...
                    <div class=" col-md-6">
                        <div class="ibox  widget-stat color-white" style="background-color: #4b647c">
                            <a href="{{url('admin/job-requests')}}" class="color-white"><div class="ibox-body">
                                <h2 class="m-b-5 font-strong">
                                    <?php
                                        $d = \App\Models\JobRequest::get();
                                        echo $d->count();
                                    ?>
                                </h2>
                                <div class="m-b-5">JOB REQUESTS</div><i class="fa fa-envelope widget-stat-icon"></i>
                    ...
                    <div class=" col-md-12">
                        <div class="ibox  widget-stat color-white" style="background-color: #4b647c">
                            <a href="{{url('admin/testimonials')}}" class="color-white"><div class="ibox-body">
                                <h2 class="m-b-5 font-strong">
                                    <?php
                                        $d = \App\Models\Testimonial::get();
                                        echo $d->count();
                                    ?>
                                </h2>
                                <div class="m-b-5">TESTIMONIALS</div><i class="fa fa-file-text widget-stat-icon"></i>
                                {{-- <div><i class="fa fa-level-down m-r-5"></i><small>-12% Lower</small></div> --}}
                            </div></a>
                        </div>
                    </div>
                    <div class=" col-md-12">
                        <div class="ibox  widget-stat color-white" style="background-color: #4b647c">
                            <a href="{{url('admin/partners')}}" class="color-white"><div class="ibox-body">
                                <h2 class="m-b-5 font-strong">
                                    <?php
                                        $d = \App\Models\Partner::get();
                                        echo $d->count();
                                    ?>
                                </h2>
                                <div class="m-b-5">PARTNERS</div><i class="fa fa-calendar widget-stat-icon"></i>
                                {{-- <div><i class="fa fa-level-down m-r-5"></i><small>-12% Lower</small></div> --}}
                            </div></a>
                        </div>
                    </div>
