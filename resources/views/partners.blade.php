    ...
    <div class="page-content fade-in-up">
        ...
        <div class="ibox">
            <div class="ibox-head">
                ...
                <div class="ibox-title">Partners</div>
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <?php
                                $data = \App\Models\Partner::orderBy('id' ,'desc')->paginate(10);
                                foreach ($data as $d) { ?>
                                <tr>
                                    ...
                                    <td style="text-align: center; direction: rtl;"><?php echo $d->name_ar; ?></td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        style="margin-bottom: 3px">
                                         ...
                                         <form method="post" action="{{url('admin/backend/partners/delete')}}">
                                            {{csrf_field()}}
                                        ...
                                        <div class="modal fade" id="exampleModal<?php echo $d->id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                              <div class="modal-content">
                                                  ...
                                                  <form method="post" action="{{url('admin/backend/partners/edit')}}" enctype="multipart/form-data"> 
                                                    {{csrf_field()}}
                                                <input type="hidden" name="id" value="<?php echo $d->id; ?>" />
                                                ...
                                                <div class="modal-body">
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    value="<?php echo $d->key; ?>"
                                                     aria-describedby="emailHelp" placeholder="Key"> --}}

                                                     
                                                     <select name="key" class="form-control" required>
                                                      <option <?php if($d->key == "our_partners") echo "selected" ; ?> value="our_partners">Our Partners</option>
                                                      <option <?php if($d->key == "business_partners") echo "selected" ; ?> value="business_partners">Business Partners</option>
                                                      <option <?php if($d->key == "technology_partners") echo "selected" ; ?> value="technology_partners">Technology Partners</option>
                                                     </select>
                                                    ...
                                                    <div class="form-group">
                                                      ...
                                                      <div class="form-group">
                                                        <label for="exampleInputPassword1">Partner icon</label>
    ...
    <div class="modal fade" id="exampleModalAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
              ...
              <form method="post" action="{{url('admin/backend/partners/add')}}"  enctype="multipart/form-data">
                {{csrf_field()}}
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                {{-- <input type="text" class="form-control" name="key" required
                 ...
                 <select name="key" class="form-control" required>
                  <option value="our_partners" selected>Our Partners</option>
                  <option value="business_partners">Business Partners</option>
                  <option value="technology_partners">Technology Partners</option>
                 </select>
      ...
      <p style="margin-top: 15px; float:right;" <?php if($data->lastPage() == 1){echo "hidden";} ?>>
                ...
                <span> << </span>
                <a href="{{url("admin/partners")}}<?php echo "?page=1"; ?>">First Page</a>
                <span <?php if($data->lastPage() == 2){echo "hidden";} ?>> | </span>
                <a href="{{url("admin/partners")}}<?php echo "?page=".round($data->lastPage()/2); ?>" <?php if($data->lastPage() == 2){echo "hidden";} ?>>Middle Page</a>
                <span> | </span>
                <a href="{{url("admin/partners")}}<?php echo "?page=".$data->lastPage(); ?>">Last Page</a>
                <span> >> </span>
